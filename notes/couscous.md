...
description: Couscous usage instructions       # description as shown in search, also used for metaDescription if not explicitly set
metaDescription: Instructions    # description as used for the <meta name="description"> content
...
nextTitle: Couscous deployment Tutorial # title of next page (default would be "example" here)
---
# Couscous Mintlook
